    ...
    <View style={styles.inputContainer}>
      ...
      >
        ...
        <CustomTextInput
          ...
          ref={lastNameRef}
          focusNextInput={() => focusNextInput(() => focusNextInput(dobRef))}
        />
        ...
        <CustomTextInput
          ...
          ref={dobRef}
          focusNextInput={() => focusNextInput(() => focusNextInput(emailRef))}
        />
        ...
        <CustomTextInput
          ...
          ref={emailRef}
          focusNextInput={() => focusNextInput(() => focusNextInput(phoneRef))}
        />
        ...
        <CustomTextInput
          ...
          ref={street2Ref}
          focusNextInput={() => focusNextInput(() => focusNextInput(suburbRef))}
        />
        ...
        <CustomTextInput
          ...
          ref={suburbRef}
          focusNextInput={() => focusNextInput(() => focusNextInput(cityRef))}
        />
